...
enum L {
    ...
    private static let table: [String: S] = [
        ...
        "a.installRestart": S(zhHans: "安装并重启", en: "Install & Relaunch", zhHant: "安裝並重啟", ja: "インストールして再起動"),
        "a.readyToInstall": S(zhHans: "%@ 已下载,就绪待安装", en: "%@ downloaded, ready to install", zhHant: "%@ 已下載,就緒待安裝", ja: "%@ をダウンロード済み、インストール可能"),
        ...
        "a.downloadInstall": S(zhHans: "下载并安装", en: "Download & install", zhHant: "下載並安裝", ja: "ダウンロードして更新"),
        "a.viewReleaseNotes": S(zhHans: "查看发布说明", en: "Release notes", zhHant: "查看發佈說明", ja: "リリースノート"),
        ...
        // Updater status
        "u.checking":       S(zhHans: "正在检查更新…", en: "Checking for updates…", zhHant: "正在檢查更新…", ja: "更新を確認中…"),
        "u.noRelease":      S(zhHans: "暂无发布或检查失败", en: "No release, or check failed", zhHant: "暫無發佈或檢查失敗", ja: "リリースなし、または確認失敗"),
        "u.newVersion":     S(zhHans: "发现新版本 %@", en: "New version %@", zhHant: "發現新版本 %@", ja: "新バージョン %@"),
        "u.upToDate":       S(zhHans: "已是最新版本 (%@)", en: "Up to date (%@)", zhHant: "已是最新版本 (%@)", ja: "最新です (%@)"),
        "u.downloading":    S(zhHans: "正在下载更新…", en: "Downloading update…", zhHant: "正在下載更新…", ja: "更新をダウンロード中…"),
        "u.downloadFailed": S(zhHans: "下载失败", en: "Download failed", zhHant: "下載失敗", ja: "ダウンロード失敗"),
        "u.installing":     S(zhHans: "正在安装,应用即将重启…", en: "Installing, app will restart…", zhHant: "正在安裝,應用即將重啟…", ja: "インストール中、まもなく再起動…"),
        "u.installFailed":  S(zhHans: "安装失败", en: "Install failed", zhHant: "安裝失敗", ja: "インストール失敗"),
        "u.downloaded":     S(zhHans: "已下载 %@,待安装", en: "Downloaded %@, ready to install", zhHant: "已下載 %@,待安裝", ja: "%@ をダウンロード済み"),
        "u.notWritable":    S(zhHans: "应用位于只读位置,无法原地更新;已打开发布页",
                              en: "The app is in a read-only location; opening the release page",
                              zhHant: "應用位於唯讀位置,無法原地更新;已打開發佈頁",
                              ja: "アプリが読み取り専用の場所にあります。リリースページを開きます"),
        "u.readyTitle":     S(zhHans: "OmniStats %@ 已就绪", en: "OmniStats %@ is ready", zhHant: "OmniStats %@ 已就緒", ja: "OmniStats %@ の準備ができました"),
        "u.readyBody":      S(zhHans: "更新已下载。现在安装并重启吗?",
                              en: "The update has been downloaded. Install and relaunch now?",
                              zhHant: "更新已下載。現在安裝並重啟嗎?",
                              ja: "更新をダウンロードしました。今すぐインストールして再起動しますか?"),
        "u.installNow":     S(zhHans: "安装并重启", en: "Install & Relaunch", zhHant: "安裝並重啟", ja: "インストールして再起動"),
        "u.later":          S(zhHans: "稍后", en: "Later", zhHant: "稍後", ja: "後で"),
    ]
}
